...
router.get("/", (req, res, next) => {
  ...
  // res.sendFile(path.join(rootDir, "views", "shop.pug")); //exporting the html path using path.join we use this method every where

  // we use this after using template engine
  // we use default Templating Engine -
